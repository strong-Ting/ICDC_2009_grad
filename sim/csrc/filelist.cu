...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _7909_archive_1.so
_7909_archive_1.so : archive.44/_7909_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared -m elf_i386  -Bsymbolic  -o .//../simv.daidir//_7909_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_7909_archive_1.so $@

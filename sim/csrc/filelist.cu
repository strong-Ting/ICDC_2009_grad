...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _29129_archive_1.so
_29129_archive_1.so : archive.38/_29129_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared -m elf_i386  -Bsymbolic  -o .//../simv.daidir//_29129_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_29129_archive_1.so $@

...
spyParseTextMessageTagFile("./spyglass-1/txv_verification/txv_rtl_gen/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(1,"./spyglass-1/txv_verification/txv_rtl_gen/spyglass.vdb");

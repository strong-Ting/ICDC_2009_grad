...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _10105_archive_1.so
_10105_archive_1.so : archive.77/_10105_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared -m elf_i386  -Bsymbolic  -o .//../simv.daidir//_10105_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_10105_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _32041_archive_1.so
_32041_archive_1.so : archive.88/_32041_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared -m elf_i386  -Bsymbolic  -o .//../simv.daidir//_32041_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_32041_archive_1.so $@

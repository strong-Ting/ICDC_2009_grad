...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _7550_archive_1.so
_7550_archive_1.so : archive.53/_7550_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared -m elf_i386  -Bsymbolic  -o .//../simv.daidir//_7550_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_7550_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.53/_prev_archive_1.a
	@$(AR) -s $<

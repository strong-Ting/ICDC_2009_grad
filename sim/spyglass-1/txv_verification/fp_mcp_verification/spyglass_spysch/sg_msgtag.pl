...
spyParseTextMessageTagFile("./spyglass-1/txv_verification/fp_mcp_verification/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(1,"./spyglass-1/txv_verification/fp_mcp_verification/spyglass.vdb");

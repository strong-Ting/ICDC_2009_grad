...
set cycle  19         ;	#clock period defined by designer
...
set_input_delay [expr $cycle / 2] -clock clk [get_ports cmd*]
set_input_delay 1 -clock clk [get_ports M_D*]
...
set_output_delay 1 -clock clk [get_ports M_RW]
set_output_delay 1 -clock clk [get_ports M_A*]
set_output_delay 1 -clock clk [get_ports M_D*]
